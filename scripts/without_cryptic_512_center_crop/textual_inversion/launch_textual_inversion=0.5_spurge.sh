...
--logdir /home/kdoherty/spurge/semantic-aug/results/512_center_crop/without_cryptic/textual-inversion-0.5 \
...
--embed-path /home/kdoherty/spurge/semantic-aug/data/all_embeddings_512_center_crop.bin \
--synthetic-dir /home/kdoherty/spurge/semantic-aug/results/512_center_crop/without_cryptic/synthetic_images/{dataset}-{aug}-{strength}-{seed}-{examples_per_class} \
