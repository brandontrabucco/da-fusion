...
--logdir /home/kdoherty/spurge/semantic-aug/results/512_center_crop/without_cryptic/real-guidance-0.5 \
...
--dataset spurge --aug real-guidance --prompt "a woodland seen from a drone" \
