...
--logdir /home/kdoherty/spurge/semantic-aug/results/250_qtr/integrated_stacking_prob50 \
...
--synthetic-dir /home/kdoherty/spurge/semantic-aug/results/250_qtr/synthetic_images/{dataset}-{aug}-{strength}-{seed}-{examples_per_class}-prob50 \
--num-synthetic 50 \
