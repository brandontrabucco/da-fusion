...
RANK=$SLURM_ARRAY_TASK_ID python ./semantic_aug/fine_tune_pooled_tokens.py no_spurge
RANK=$SLURM_ARRAY_TASK_ID python ./semantic_aug/fine_tune_pooled_tokens.py leafy_spurge

RANK=$SLURM_ARRAY_TASK_ID python spurge_classifier_five_fold.py \
--logdir ./results/250_qtr/spurge_five_fold_pooled \
...
--synthetic-dir ./results/250_qtr/synthetic_images/spurge_five_fold_pooled \
--num-synthetic 10 \
--num-epochs 500 \
