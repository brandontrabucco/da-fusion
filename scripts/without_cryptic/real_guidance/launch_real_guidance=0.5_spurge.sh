...
--logdir /home/kdoherty/spurge/semantic-aug/results/without_cryptic/real-guidance-0.5 \
--checkpoint /home/kdoherty/spurge/models/stable-diffusion-v1-4 \
--synthetic-dir /home/kdoherty/spurge/semantic-aug/results/without_cryptic/synthetic_images/{dataset}-{aug}-{strength}-{seed}-{examples_per_class} \
