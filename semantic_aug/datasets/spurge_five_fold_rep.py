...
class SpurgeDataset5Fold(FewShotDataset):
    ...
    def __init__(self, *args, data_dir: str = DEFAULT_DATA_DIR, 
        ...
        super(SpurgeDataset5Fold, self).__init__(
            *args,
        ...
        absent_ids = rng.permutation(absent_size)
        apparent_ids = rng.permutation(apparent_size)

        absent_ids_train = absent_ids[:absent_train_size]
        absent_ids_val = absent_ids[absent_train_size:]
        
        apparent_ids_train = apparent_ids[:apparent_train_size]
        apparent_ids_val = apparent_ids[apparent_train_size:]
