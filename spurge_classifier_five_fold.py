from semantic_aug.datasets.spurge_five_fold_rep import SpurgeDataset5Fold
...
DATASETS = {"spurge": SpurgeDataset5Fold}


def run_experiment(seed: int = 0, 
                   dataset: str = "spurge",
                   aug: str = "integrated-stacking", 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--aug", type=str, default="integrated-stacking")
